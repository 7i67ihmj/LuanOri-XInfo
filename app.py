...
def get_account_credentials(region: str) -> str:
    ...
    if r == "IND":
        return "uid=4216531078&password=DELTA-UOOLVDO5C-CORE"

    elif r in {"BR", "US", "SAC", "NA"}:
        return "uid=4216531078&password=DELTA-UOOLVDO5C-CORE"

    elif r == "VN":
        return "uid=5088118279&password=F77E52369E724FE9293DCD16853951679F6F0FC23B86BACB82B833ED8C59D9AE"
...
if __name__ == "__main__":
    # Khởi tạo tokens trong main thread
    loop = asyncio.new_event_loop()
    asyncio.set_event_loop(loop)
    loop.run_until_complete(initialize_tokens())
    
    # Chạy refresh task trong background
    def run_async():
        asyncio.set_event_loop(loop)
        loop.run_until_complete(refresh_tokens_periodically())
